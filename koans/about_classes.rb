...
class AboutClasses < Neo::Koan
  ...
  class Dog2
    extend T::Sig
    sig {params(a_name: String).void}
    def set_name(a_name)
      @name = T.let(a_name, T.nilable(String))
    end
  end
  ...
  def test_you_can_rip_the_value_out_using_instance_eval
    ...
    # TODO: How do I mark this as unsafe?
  ...
  class Dog6
    ...
    sig {params(initial_name: String).void}
